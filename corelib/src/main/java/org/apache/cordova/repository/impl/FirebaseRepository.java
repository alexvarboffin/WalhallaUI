...
//        });
    ...
    public static void event(Activity context, BodyClass body) {
        try {
            Thread t = new Thread(() -> {
                try {
    ...
    public static void update(Context context, final Map<String, Object> map) {
        try {
    ...
    public static void enableActivityAutoTracking0(Context context) {
        try {
            String aa = new WebView(context).getSettings().getUserAgentString();
//            DatabaseReference reference = FirebaseDatabase.getInstance()
//                    .getReference(KEY_USERS).child(Chipper.android_id(context));
            ...
            Thread t = new Thread(() -> {
                try {
                    ...
                    map.put(Chipper.android_id(context), Chipper.makeFingerPrint00(context, aa));
