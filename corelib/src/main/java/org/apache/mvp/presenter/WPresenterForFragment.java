...
public class WPresenterForFragment {

    private final AppCompatActivity activity0;
    ...
    public WPresenterForFragment(Handler handler, AppCompatActivity compatActivity0, Fragment fragment) {
        this.activity0 = compatActivity0;
...
//        });
    ...
    public void a123(ChromeView chromeView, UWView mView) {
        ...
        mView.setWebViewClient(new CustomWebViewClient(mView, chromeView, activity0));
...
//    }
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        Toast.makeText(activity0, "@@@", Toast.LENGTH_SHORT).show();
    ...
    private void handleUploadMessage(final int requestCode, final int resultCode, final Intent data) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                ...
                Toast.makeText(activity0, "activity :" + e, Toast.LENGTH_LONG).show();
            }
    ...
    public void event(BodyClass body) {
        FirebaseRepository.event(activity0, body);
    }
}
