...
import com.walhalla.landing.databinding.ActivityCollapsingToolbarBinding
...
abstract class BaseCollapsingActivity : WebActivity(), ChromeView {
    protected var doubleBackToExitPressedOnce: Boolean = false

    //private Handler mHandler;
    protected var binding: ActivityCollapsingToolbarBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCollapsingToolbarBinding.inflate(
            layoutInflater
        )
