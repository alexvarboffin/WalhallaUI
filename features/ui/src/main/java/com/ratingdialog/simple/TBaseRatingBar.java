...
public class TBaseRatingBar extends LinearLayout implements SimpleRatingBar {

    public interface OnRatingChangeListener {
        void onRatingChange(TBaseRatingBar ratingBar, float rating);
    }
    ...
    public TBaseRatingBar(Context context) {
        this(context, null);
    }

    /* Call by xml layout */
    public TBaseRatingBar(Context context, @Nullable AttributeSet attrs) {
     ...
     */
    public TBaseRatingBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public TBaseRatingBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
