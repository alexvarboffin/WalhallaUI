...
import com.video.photoeditor.R;
...
public class EditPhotoActivity extends BaseActivity implements View.OnClickListener,
    ...
    public static final String KEY_INTENT_PHOTO = "PHOTO";
...
//        ImageViewCompat.setImageTintList(textView, ColorStateList.valueOf(tintColor));
    ...
    private void setupTabIconsImageTool() {
        ImageView textView = (ImageView) LayoutInflater.from(this).inflate(R.layout.main_tab, null);
        ...
        ImageView textView2 = (ImageView) LayoutInflater.from(this).inflate(R.layout.main_tab, null);
        textView2.setImageResource(R.drawable.ic_overplay);
        this.tablayoutImageTools.getTabAt(1).setCustomView(textView2);
        int i = 2;
        if (Build.VERSION.SDK_INT >= 21) {
            ImageView textView3 = (ImageView) LayoutInflater.from(this).inflate(R.layout.main_tab, null);
        ...
        ImageView textView4 = (ImageView) LayoutInflater.from(this).inflate(R.layout.main_tab, null);
        ...
        ImageView textView5 = (ImageView) LayoutInflater.from(this).inflate(R.layout.main_tab, null);
        ...
        this.tablayoutImageTools.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if (tab.getPosition() != EditPhotoActivity.this.addTextTabIndex) {
                    ...
                    EditPhotoActivity.this.mPhotoEditor.addText(
                            EditPhotoActivity.this.getString(R.string.doubletap), EditPhotoActivity.this.getResources().getColor(17170443));
                } else {
    ...
    private void getData() {
        ...
        if (intent.hasExtra(KEY_INTENT_PHOTO)) {
            this.listPhoto = intent.getStringArrayListExtra(KEY_INTENT_PHOTO);
        }
        if (intent.hasExtra(KEY_INTENT_POSITION)) {
            this.position = this.intent.getIntExtra(KEY_INTENT_POSITION, 0);
        }
    ...
    private void addControls() {
        ...
        this.btnBack = findViewById(R.id.btnBackPhoto);
        this.btnRedo = findViewById(R.id.btnRedo);
        this.btnFinish = findViewById(R.id.btnFinishPhoto);
        this.btnBackTextTools = findViewById(R.id.btnBackTextTools);
        this.btnAddText = findViewById(R.id.btnAddText_toolbar);
        this.rl_text_tool = findViewById(R.id.rl_text_tool);
        this.rl_main_tool = findViewById(R.id.rl_main_tool);
        this.rl_photo_tools = findViewById(R.id.rl_photo_tool);
        this.rl_color_photo = findViewById(R.id.rl_color_photo);
        this.rlEdit = findViewById(R.id.relativeEdit);
    ...
    public void onClick(View view) {
        ...
        if (id != R.id.imgPhotoEditor) {
            ...
            } else if (id == R.id.btnBackTextTools) {
                if (this.countMain == 0) {
...
//    private class com.video.photoeditor.activity.CreateMovieAsync extends AsyncTask<Void, Void, Void> {
