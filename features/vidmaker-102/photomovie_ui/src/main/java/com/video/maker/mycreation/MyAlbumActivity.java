...
//
//            Intent intent = new Intent(MyAlbumActivity.this, ShareActivity.classZZ);
...
//                intent.putExtra(ARG_KEY_ISPHOTO, ARG_KEY_NO);
//            }else {
//                intent.putExtra(KEY_INTENT_PHOTO, Uri.fromFile(new File(videoPath.get(position))));
//                intent.putExtra(ARG_KEY_ISPHOTO, ARG_KEY_YES);
//            }
