...
import static com.hw.photomovie.PhotoMovieFactory.MY_BLACK_COLOR;
...
public class PlayPauseView extends View {
    ...
    private int mBtnColor = MY_BLACK_COLOR;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        int[] PlayPauseView = {R.attr.anim_direction, R.attr.anim_duration,
                R.attr.bg_color, R.attr.btn_color, R.attr.gap_width, R.attr.space_padding};
        ...
        this.mBtnColor = obtainStyledAttributes.getColor(3, MY_BLACK_COLOR);
