    ...
    public void onClick(View view) {
        if (this.listener != null) {
            ...
            if (id == R.id.ic_christmas) {
                ...
                return;
            } else if (id == R.id.ic_food) {
                this.listener.onFood();
                return;
            } else if (id == R.id.ic_love) {
                this.listener.onLove();
                return;
            } else if (id == R.id.ic_motivation) {
                this.listener.onMotivation();
                return;
            } else if (id == R.id.ic_phrases) {
                this.listener.onPhrases();
                return;
            } else if (id == R.id.ic_sayings) {
                this.listener.onSayings();
                return;
            } else if (id == R.id.ic_summer) {
                this.listener.onSummer();
                return;
            } else if (id == R.id.ic_travel) {
                this.listener.onTravel();
                return;
            } else if (id == R.id.ic_winter) {
