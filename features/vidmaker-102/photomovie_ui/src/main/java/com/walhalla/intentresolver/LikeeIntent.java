...
public class LikeeIntent extends DefaultIntent {

    //sg.bigo.live.share.receivesharing.SharingActivity
    //video.like/sg.bigo.live.produce.publish.MediaSharePublishActivity
...
//                    } else {
                    context.grantUriPermission(SharedNetwork.Package.LIKEE, uri, Intent.FLAG_GRANT_WRITE_URI_PERMISSION | Intent.FLAG_GRANT_READ_URI_PERMISSION);
                    shareIntent.setPackage(SharedNetwork.Package.LIKEE);
                    context.startActivity(shareIntent);
//                    }
