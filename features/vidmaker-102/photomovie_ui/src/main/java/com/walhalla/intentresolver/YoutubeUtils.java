...
public class YoutubeUtils {
    public static final String BASEAA = "Motivational Quotes / Motivational status video";

    public static String makeSimpleTitle(String item) {
        String simpleTitle = item + " "
                //+smile
                + BASEAA + "️. #shorts #viral #motivational";
        return simpleTitle;
    }

//    static String _description_0 = """
//            %1$s
//
//
//
