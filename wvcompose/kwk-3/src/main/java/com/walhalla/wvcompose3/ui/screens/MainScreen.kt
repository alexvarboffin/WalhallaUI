package com.walhalla.wvcompose3.ui.screens
...
import com.walhalla.wvcompose3.config.LoadingType
import com.walhalla.wvcompose3.config.MenuItem
import com.walhalla.wvcompose3.config.MenuItemType
import com.walhalla.wvcompose3.config.WebViewConfig
import com.walhalla.wvcompose3.game.SlotMachineScreen
import com.walhalla.wvcompose3.ui.components.BookmarksSheet
import com.walhalla.wvcompose3.ui.components.ReaderModeControls
import com.walhalla.wvcompose3.ui.components.SearchBar
import com.walhalla.wvcompose3.ui.components.enableReaderMode
    ...
    Scaffold(
        topBar = {
            if (config.showToolbar) {
                Column {
                    TopAppBar(
                        title = { Text(if (showGame) "Игра" else "WebView") },
                        navigationIcon = {
